...
class BaseConfig:
    ...
    # - train_split 默认用我们刚刚切好的 train
    # - eval_split 默认用 val
    # - test_split 默认用 test
    train_split: str = "tiny"   # 也可以改成 "tiny" / "full" 做不同实验
    eval_split: str = "val"
    test_split: str = "test"
    ...
    data_paths: Dict[str, Dict[str, str]] = field(
        default_factory=lambda: {
            ...
            "T4_tool": {
                ...
                "val": "data/split/T4_tool_val.jsonl",   # 当前样本为 0，但不会报错，只是没意义
    ...
    # 设备
    # =======================
    device: str = "cuda"   # 如果没有 GPU，可以改为 "cpu"
